"""
Django settings for WebTrabalho2 project.
...
SECRET_KEY = 'django-insecure-m&gk%-!gk&y2%ufg))v-%o)s_q!oy0kyk(ljp9+36h^nb3==hh'
...
ROOT_URLCONF = 'WebTrabalho2.urls'
...
WSGI_APPLICATION = 'WebTrabalho2.wsgi.application'
